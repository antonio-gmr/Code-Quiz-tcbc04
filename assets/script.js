...
const quizQuestions = [
    {
      question: "Which tab would you use to insert a JavaScript program in a HTML?",
      a: "<code>",
      b: "<data>",
      c: "<script>",
      d: "<body>",
    ...
    {
      question:
        "Wich of the following is correct?",
      a: "Numer, Coordenate, Axis",
      b: "String, Boolean, Non Booolean",
      c: "String, Boolean, Undefined",
      d: "Unrecognized, Object, Code",
      correct: "c",
    },
    {
  ...
  const my_page =
    "/Users/agm/Desktop/Bootcamp Challenges/04-Challenge/score.html";
  ...
  function submitName() {
      quiz.innerHTML = `<h2>You answered ${score}/${quizQuestions.length} questions correctly</h2>
              ...
              <form class = 'form'>
                  <input type = 'text' id='score_name' placeholder='Name here!"' required>
              </form>
